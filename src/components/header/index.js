...
class Header extends React.Component{
    menu = () => {
        return (
            <Menu class="header-menu" styles={"background-color:red"} onClick={onClick}>
    ...
    render(){
        return (
            ...
            <div className="header-right">
                ...
                >   
                    <span className="">
                        <img className="header-notification__icon" src={speaker} alt="speaker"></img>
                        <span className='header-notification__unread'>10</span>
                    </span>
                </Popover>,
                <Dropdown overlay={this.menu} trigger='click'>
                    <a className="header-right__content" onClick={e => e.preventDefault()}>
                        <img className="header-right__content__avatar" src={avatar} alt="logo"></img>
